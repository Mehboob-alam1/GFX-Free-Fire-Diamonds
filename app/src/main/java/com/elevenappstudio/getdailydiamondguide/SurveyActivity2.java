...
public class SurveyActivity2 extends AppCompatActivity {
    ...
    private void setupSurveyContent() {
        // Set survey 2 content - You can replace these
        surveyTitle.setText("Survey 2 of 3");
        surveyQuestion.setText("What type of games do you prefer?");
        option1.setText("Action & Adventure");
        option2.setText("Strategy & Puzzle");
        option3.setText("Racing & Sports");
        option4.setText("Casual & Arcade");
    }
    ...
    private void setupListeners() {
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId == -1) {
                    Toast.makeText(SurveyActivity2.this, "Please select an option", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                // Log.d("Survey2", "Selected: " + selectedAnswer);
    ...
    private void openAdWebView() {
        ...
        if (FirebaseUrlManager.getInstance().shouldShowAds()) {
            ...
            Intent intent = new Intent(SurveyActivity2.this, AdWebViewActivity.class);
            intent.putExtra(AdWebViewActivity.EXTRA_URL, url);
            intent.putExtra(AdWebViewActivity.EXTRA_SURVEY_NUMBER, 2);

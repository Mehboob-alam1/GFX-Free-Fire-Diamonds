...
public class SurveyActivity3 extends AppCompatActivity {
    ...
    private void setupSurveyContent() {
        // Set survey 3 content - You can replace these
        surveyTitle.setText("Survey 3 of 3");
        surveyQuestion.setText("How important is game performance to you?");
        option1.setText("Very important");
        option2.setText("Somewhat important");
        option3.setText("Neutral");
        option4.setText("Not important");
    }
    ...
    private void setupListeners() {
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId == -1) {
                    Toast.makeText(SurveyActivity3.this, "Please select an option", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                // Log.d("Survey3", "Selected: " + selectedAnswer);
    ...
    private void openAdWebView() {
        ...
        if (FirebaseUrlManager.getInstance().shouldShowAds()) {
            ...
            Intent intent = new Intent(SurveyActivity3.this, AdWebViewActivity.class);
            intent.putExtra(AdWebViewActivity.EXTRA_URL, url);
            intent.putExtra(AdWebViewActivity.EXTRA_SURVEY_NUMBER, 3);
